...
data_root = os.path.expanduser('C:\\Users\\Nu\\Documents\\CPE\\3d_face_recognition\\3dface_dir\\3dface_train_align')
assert os.path.exists(data_root),     'Dataset directory not found: %s' % data_root

split_radio = (0.8, 0.2, 0.0)
assert sum(split_radio) == 1
min_num_images_per_class = 8
